...
const renderAboutPage = (options) => {
    ...
    const aboutDescriptor = (0, markdown_1.parseMdWithSimpleDescriptor)(aboutMd, 'about');
    if (aboutDescriptor) {
        const aboutPost = {
...
const renderExtraPages = (options) => {
    ...
    R.forEach((item) => {
        ...
        if (item.source) {
            ...
            const pageDescriptor = (0, markdown_1.parseMdWithSimpleDescriptor)(pageMd, item.source);
            if (pageDescriptor) {
                const pagePost = {
